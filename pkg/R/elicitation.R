...
#' @examples elicitNGa(muquantile1=-1,muquantile2=1,tauquantile1=0.1,tauquantile2=1.1)
...
#' @return value
#' @keywords character
elicitgzerofn=function(g,taup1,tauquantile1,taup2,tauquantile2){(qgamma(taup1,g,1)/qgamma(taup2,g,1)-tauquantile1/tauquantile2)^2}
