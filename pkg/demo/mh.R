...
# Fig 4.6
mcmcSummary(posterior,rows=1,show=F)
...
posterior=mwgGammars(N=20000,initial=(0.62/0.4)^2,innov=0.9,priorparam=c(2,1,3,1),n=50,xbar=0.62,xgbar=0.46,show=TRUE) 
